...
const MPContractAddress = "0x1587aaDcf97a2cEd5921965E24503ced732c2E6b"
const app = express();
const PORT = 8080

// let contract
async function getKit(addressofmint, nft) {
...
console.log(web3.eth.accounts.wallet.add('6c5e33da18cbacd114b6c7370017898e3d40d38f0b8f50591b807ceda8555fef'))
const json =[
	{
		"anonymous": false,
		"inputs": [
...
console.log(contract.defaultBlock)
  ...
  console.log(addressofmint)
  console.log(urlofimage)
  let txObject = await contract.methods.mint(addressofmint,1)
  const receipt = await txObject
 .send({
   
   from:"0xae39C6C1c98F3671cf8582617c66F637C3148fCb",
